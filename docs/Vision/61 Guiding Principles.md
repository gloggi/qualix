...
- Qualix is supposed to be flexible enough to support many different approaches to observations, feedbacking and qualifications. Unused features are silently hidden until they are activated.
...
- Qualix is optimized for use on laptops, but provides a responsive layout which is useable on tablets and phones as well.
