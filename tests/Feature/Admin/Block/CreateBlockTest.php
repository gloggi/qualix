...
class CreateBlockTest extends TestCaseWithCourse {
    ...
    public function setUp(): void {
        ...
        $this->payload = ['full_block_number' => '1.1', 'name' => 'Block 1', 'block_date' => '1.1.2019', 'requirements' => null];
    }
    ...
    public function test_shouldShowDateFromLastCreatedBlockInForm_whenBlockHasBeenCreated() {
        ...
        $this->assertMatchesRegularExpression('/<input-date.*model-value="2019-01-01"/s', $response->content());
    }
}
