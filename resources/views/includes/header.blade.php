                ...
                @if($course)
                    ...
                    <b-nav-item-dropdown text="{{__('t.header.course_admin')}}" {{ substr( Route::currentRouteName(), 0, 5 ) == 'admin' ? ' active' : '' }}>
                        ...
                        @if(!$course->archived)
                            ...
                            <b-dropdown-item dropdown-item{{ Route::currentRouteName() == 'admin.observationOrders' ? ' active' : '' }}
                                             href="{{ route('admin.observationOrders', ['course' => $course->id]) }}">{{__('t.views.admin.observation_orders.menu_name')}}</b-dropdown-item>
                        @endif
