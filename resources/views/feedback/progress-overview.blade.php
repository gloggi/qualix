                    ...
                    @foreach ($feedbacks as $feedback)
                        <b-list-group-item>
                            <div class="d-flex align-items-baseline">
                                <a href="{{ route('participants.detail', ['course' => $course->id, 'participant' => $feedback->participant_id]) }}"><img src="{{ $feedback->participant->image_path }}" class="avatar-small" alt="{{ $feedback->participant->scout_name }}"/></a>
