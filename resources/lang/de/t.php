	...
	"views" => array(
		"admin" => array(
			...
			"requirements" => array(
				...
				"create_success" => "Mindestanforderung wurde erfolgreich erstellt.",
				"delete_success" => "Mindestanforderung wurde erfolgreich gelöscht.",
				"edit" => "Mindestanforderung bearbeiten",
				"edit_success" => "Mindestanforderung wurde erfolgreich gespeichert.",
