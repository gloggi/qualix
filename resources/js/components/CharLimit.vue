<template>
  <div>
    <div class="progress position-relative">
      ...
      <span class="justify-content-center align-self-center d-flex position-absolute w-100">{{this.$t('t.views.observations.char_limit')}} <strong class="ml-1"> {{ value.toFixed(0) }} / {{ limit }}</strong></span>
    </div>
