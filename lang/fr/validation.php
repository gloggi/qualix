...
return array(
	...
	"valid_feedback_content_without_observations" => "Le champ :attribute sélectionné est invalide.",
	"valid_feedback_content" => "Le champ :attribute sélectionné est invalide.",
);